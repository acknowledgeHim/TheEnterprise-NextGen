...
class dns_reverse():
    ...
    def __init__(self, range, verbose=True):
        ...
        try:
            ...
            print_text.print_error("Error in DNS resolvers")
            sys.exit()
    ...
    def get_ip_list(self, ips):
        ...
        try:
            ...
            print_text.print_error("Error in IP format, check the input and try again. (Eg. 192.168.1.0/24)")
            sys.exit()
        name = []
        for x in list:
            name.append(str(x))
...
class dns_force():
    ...
    def __init__(self, domain, dnsserver, verbose=False):
        ...
        try:
            ...
            print_text.print_error("Error opening dns dictionary file")
            sys.exit()
    ...
    def run(self, host):
        if self.nameserver == "":
            ...
            print_text.print_msg("Using DNS server: " + self.nameserver)
