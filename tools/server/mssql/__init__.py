...
TDS_HeaderTypes = {
    ...
    TDS_TYPES_RPC				:"TDS_TYPES_RPC ",TDS_TYPES_TABULAR_RESULT	: "TDS_TYPES_TABULAR_RESULT",
...
TDS_Status = {
    ...
    TDS_STATUS_RESET_CON      :"RESETCONNECTION",TDS_STATUS_RESET_CON_TRAN : "RESETCONNECTIONSKIPTRAN"
}
...
class TDS_Token_Info(Packet):
    ...
    fields_desc = [
        ...
        StrLenField("MessageText", "Changed database context to 'master'.".encode('utf16')[2:],
